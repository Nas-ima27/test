...
const NAV_ITEMS = [
  { to: "/espace-encadrant", label: "Mon tableau de bord", icon: LayoutDashboard, end: true },
  { to: "/espace-encadrant/sujets", label: "Mes sujets", icon: ClipboardList },
...
export function EncadrantSidebar() {
  const { user, logout } = useAuth(); // MODIFIÉ — remplace currentEncadrant en dur
      ...
      <div className="border-t border-white/5 p-3">
        <div className="flex items-center gap-3 px-2 py-2">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-slate-500 truncate">Encadrant</p>
          </div>
        </div>
