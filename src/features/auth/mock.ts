...
export const mockCredentials: { email: string; password: string; user: AuthUser }[] = [
  {
    ...
    password: "admin123",
    user: { id: 0, name: "Yasmine Bennani", email: "yasmine.bennani@sgas.ma", role: "Admin", initials: "YB" },
  },
  {
    email: "karima.alaoui@sgas.ma", // correspond à mockEncadrants id 1
    password: "encadrant123",
    user: { id: 1, name: "Dr. Karima Alaoui", email: "karima.alaoui@sgas.ma", role: "Encadrant", initials: "KA" },
  },
  {
    email: "sara.elamrani@emi.ac.ma", // correspond à mockStagiaires id 1
    password: "stagiaire123",
    user: { id: 1, name: "Sara El Amrani", email: "sara.elamrani@emi.ac.ma", role: "Stagiaire", initials: "SE" },
  },
];